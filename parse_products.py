...
for line in lines:
    ...
    # Regex to parse: Category – Name – MRP: X – DP: Y – SP: Z
    # Note: The separator is '–' (en-dash) or '-' (hyphen), need to handle both
    # Also some lines might be just headers, we should skip them if they don't match pattern
    
    # Pattern: Category - Name - MRP: 123 - DP: 123 - SP: 123
    # Allow for some variation in spacing and dash types
    ...
    if match:
        ...
        # Try to see if it's a header or just a line to ignore
        pass
